...
resource "aws_dms_endpoint" "source_endpoint" {
  ...
  username            = "admin"
  password            = "password"
  server_name         = "sourcedb.cbece4iewq9j.us-east-1.rds.amazonaws.com" # Replace with the source RDS endpoint
  port                = 3306
...
resource "aws_dms_endpoint" "target_endpoint" {
  ...
  server_name         = "myseconddb.cbece4iewq9j.us-east-1.rds.amazonaws.com" # Replace with the target RDS endpoint
  port                = 3306
}
